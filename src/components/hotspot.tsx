...
const Hotspot: React.FC<HotspotProps> = ({
    ...
    const shouldShowBeam =
        (hotspot.hasLightBeam ||
            hotspot.title.toLowerCase().includes("camera")) &&
        isHovered;
    ...
    const calculatedLeft =
        imageProps.left + (hotspot.x / 100) * imageProps.width;
    const calculatedTop =
        imageProps.top + (hotspot.y / 100) * imageProps.height;

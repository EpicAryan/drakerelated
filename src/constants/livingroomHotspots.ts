...
export const livingroomHotspots: HotspotTypeWithIcons[] = [
  {
    ...
    featuresWithIcons: [
        ...
        { text: "Group control for multiple bulbs", icon: Group },
  ...
  },
  {
    ...
    brandClass: "h-auto w-12 absolute right-4 -translate-y-3.5 lg:-translate-y-2.5 xl:-translate-y-2",
    brandLogoWidth: 200,
    brandLogoHeight: 48,
    productName: "Indoor Camera",
    featuresWithIcons: [
      { text: "360° pan and tilt", icon: Repeat2 },
      { text: "Night vision", icon: Moon },
      { text: "MicroSD card support", icon: Database  },
      ...
      { text: "Motion and human detection", icon: ScanFace },
      { text: "Two-way audio", icon: Mic },
    ],
    hasLightBeam: true,
    beamAngle: 50, 
    beamLength: 900,
  ...
  },
  {
    ...
    brandClass: "h-auto w-12 sm:w-16 invert brightness-0 translate-y-3 lg:translate-y-2.5",
    brandLogoWidth: 200,
    brandLogoHeight: 48,
    productName: "Baby Camera",
    featuresWithIcons: [
      { text: "3MP Full HD Video Quality", icon: Monitor },
      { text: "360° Pan & 85° Tilt View", icon: Repeat2 },
      { text: "Infrared Night Vision up to 10m", icon: Moon },
      { text: "Two-Way Audio Communication", icon: Volume2 },
      { text: "Motion Detection & Auto Tracking", icon: Scan },
      { text: "microSD Support up to 128GB", icon: Database },
      { text: "H.264/H.265 Video Compression", icon: Film },
      { text: "Works with Alexa & Google Assistant", icon: Mic },
  ...
  },
  {
    ...
    featuresWithIcons: [
      { text: "Mobile app control", icon: Smartphone },
      { text: "No hub required", icon: Power },

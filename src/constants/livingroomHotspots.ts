...
export const livingroomHotspots: HotspotTypeWithIcons[] = [
  {
    ...
    mediaType: "video",
    imageClassName: "w-auto h-40 xl:h-46 absolute top-1",
    cardPosition: 'right',
  ...
  },
  {
    ...
    magnifierZoom: 0.9,
    magnifierRadius: 50,
    magnifierImage: "/magnify/indoorcam.webp",
  ...
  },
  {
    ...
    featuresWithIcons: [
      ...
      { text: "360° Pan & 85° Tilt View", icon: Moon },
      { text: "Infrared Night Vision up to 10m", icon: Moon },
      { text: "Two-Way Audio Communication", icon: Volume2 },
      { text: "Motion Detection & Auto Tracking", icon: Eye },
      { text: "microSD Support up to 128GB", icon: Radio },
      { text: "H.264/H.265 Video Compression", icon: Gauge },
      { text: "Works with Alexa & Google Assistant", icon: Mic },
      { text: "2.4GHz Wi-Fi, Easy Setup", icon: Wifi },
      { text: "2-Year Warranty, Indoor Use Design", icon: Settings }
    ],
    hasLightBeam: true,
    beamAngle: 175, 
    beamLength: 900,

...
export const kitchenHotspots: HotspotTypeWithIcons[] = [
  {
    ...
    brandClass: "h-auto w-9 sm:w-12 absolute right-4 -translate-y-2.5 lg:-translate-y-2.5 xl:-translate-y-2",
    brandLogoWidth: 200,
    brandLogoHeight: 48, 
    ...
    featuresWithIcons: [
      ...
      { text: "No hub required", icon: PlugZap },
      ...
      { text: "PU coating for durability", icon: Shield },
      { text: "Up to 50,000 hours lifespan", icon: Hourglass },
      { text: "Voice control via Alexa, Google Assistant, and Siri Shortcuts", icon: Bot },
    ],
    cardOffsetY: -95,
    buttonText: "Buy Now",
    hasMagnifier: false,
  ...
  },
  {
    ...
    brandClass: "h-auto w-12 sm:w-14 xl:w-16 absolute right-4 translate-y-1 xl:translate-y-1.5",
    brandLogoWidth: 200,
    brandLogoHeight: 48, 
    ...
    featuresWithIcons: [
      ...
      { text: "Two-way audio for instant communication", icon: Mic2 },
      ...
      { text: "Voice assistant compatibility (Alexa/Google)", icon: Bot },

...
export const exteriorHotspots: HotspotTypeWithIcons[] = [
  {
    ...
    // brandClass: "h-auto w-14 sm:w-18",
     brandClass: "h-auto w-14 sm:w-18  xl:translate-y-1",
    brandLogoWidth: 200,
    brandLogoHeight: 48,
    ...
    featuresWithIcons: [
      ...
      { text: "Motion and person detection", icon: Eye },
      { text: "Two-way audio with echo cancellation", icon: Mic2 },
  ...
  },
  {
    ...
    // brandClass: "h-auto w-14 sm:w-18",
    brandClass: "h-auto w-14 sm:w-20 translate-y-0.5 xl:translate-y-1.5",
    brandLogoWidth: 200,
    brandLogoHeight: 48,
  ...
  },
  {
    ...
    brand: "/qubo-logo.webp",
    // brandClass: "h-auto w-14 sm:w-18",
    brandClass: "h-auto w-14 sm:w-18 translate-y-1.5 xl:translate-y-1",
    brandLogoWidth: 200,
    brandLogoHeight: 48,

...
export const exteriorHotspots: HotspotTypeWithIcons[] = [
  ...
  },
  {
    ...
    image: "https://images.ctfassets.net/m3x6aw9x53qp/18EkVIP8ltmLZlRRjwrOHA/9e8f668e76e78e8b36b794ae9d63b278/Yale_doorlock.webp",
    mediaType: "image",
    ...
    imageClassName: "w-auto h-48 xl:h-52 absolute -top-2 xl:top-2",
    cardPosition: 'left',
    cardOffsetY: 36,
